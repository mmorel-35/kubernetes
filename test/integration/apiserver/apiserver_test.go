	...
	testcases := []struct {
	...
	}{
		{
			...
			object: func(t *testing.T) (metav1.Object, string, string) {
				cr, err := crclient.Create(ctx, &unstructured.Unstructured{Object: map[string]any{"apiVersion": "cr.bar.com/v1", "kind": "Foo", "metadata": map[string]any{"name": "test-1"}}}, metav1.CreateOptions{})
				if err != nil {
					t.Fatalf("unable to create cr: %v", err)
				}
		...
		},
		{
			...
			object: func(t *testing.T) (metav1.Object, string, string) {
				cr, err := crclient.Create(ctx, &unstructured.Unstructured{Object: map[string]any{"apiVersion": "cr.bar.com/v1", "kind": "Foo", "spec": map[string]any{"field": 1}, "metadata": map[string]any{"name": "test-2"}}}, metav1.CreateOptions{})
				if err != nil {
					t.Fatalf("unable to create cr: %v", err)
				}
		...
		},
		{
			...
			subresource: "status",
			object: func(t *testing.T) (metav1.Object, string, string) {
				cr, err := crclient.Create(ctx, &unstructured.Unstructured{Object: map[string]any{"apiVersion": "cr.bar.com/v1", "kind": "Foo", "metadata": map[string]any{"name": "test-3"}}}, metav1.CreateOptions{})
				if err != nil {
					t.Fatalf("unable to create cr: %v", err)
				}
		...
		},
		{
			...
			subresource: "status",
			object: func(t *testing.T) (metav1.Object, string, string) {
				cr, err := crclient.Create(ctx, &unstructured.Unstructured{Object: map[string]any{"apiVersion": "cr.bar.com/v1", "kind": "Foo", "spec": map[string]any{"field": 1}, "metadata": map[string]any{"name": "test-4"}}}, metav1.CreateOptions{})
				if err != nil {
					t.Fatalf("unable to create cr: %v", err)
				}
...
func TestGetSubresourcesAsTables(t *testing.T) {
	...
	testcases := []struct {
	...
	}{
		{
			...
			object: func(t *testing.T) (metav1.Object, string, string) {
				cr, err := subresourcesCrclient.Create(ctx, &unstructured.Unstructured{Object: map[string]any{"apiVersion": "cr.bar.com/v1", "kind": "FooSub", "metadata": map[string]any{"name": "test-1"}, "spec": map[string]any{"replicas": 2}}}, metav1.CreateOptions{})
				if err != nil {
					t.Fatalf("unable to create cr: %v", err)
				}
		...
		},
		{
			...
			accept: "application/json;as=Table;g=meta.k8s.io;v=v1",
			object: func(t *testing.T) (metav1.Object, string, string) {
				cr, err := subresourcesCrclient.Create(ctx, &unstructured.Unstructured{Object: map[string]any{"apiVersion": "cr.bar.com/v1", "kind": "FooSub", "metadata": map[string]any{"name": "test-2"}, "spec": map[string]any{"replicas": 2}}}, metav1.CreateOptions{})
				if err != nil {
					t.Fatalf("unable to create cr: %v", err)
				}
				return cr, subresourcesCrdGVR.Group, "foosubs"
...
func TestTransform(t *testing.T) {
	...
	testcases := []struct {
		...
		},
		{
			...
			object: func(t *testing.T) (metav1.Object, string, string) {
				cr, err := crclient.Create(ctx, &unstructured.Unstructured{Object: map[string]any{"apiVersion": "cr.bar.com/v1", "kind": "Foo", "metadata": map[string]any{"name": "test-2"}}}, metav1.CreateOptions{})
				if err != nil {
					t.Fatalf("unable to create cr: %v", err)
				}
				if _, err := crclient.Patch(ctx, "test-2", types.MergePatchType, []byte(`{"metadata":{"annotations":{"test":"1"}}}`), metav1.PatchOptions{}); err != nil {
		...
		},
		{
			...
			accept: "application/vnd.kubernetes.protobuf;as=PartialObjectMetadata;g=meta.k8s.io;v=v1beta1",
			object: func(t *testing.T) (metav1.Object, string, string) {
				cr, err := crclient.Create(ctx, &unstructured.Unstructured{Object: map[string]any{"apiVersion": "cr.bar.com/v1", "kind": "Foo", "metadata": map[string]any{"name": "test-4", "annotations": map[string]string{"test": "0"}}}}, metav1.CreateOptions{})
				if err != nil {
					t.Fatalf("unable to create cr: %v", err)
				}
		...
		},
		{
			...
			accept: "application/json;as=Table;g=meta.k8s.io;v=v1",
			object: func(t *testing.T) (metav1.Object, string, string) {
				cr, err := crclient.Create(ctx, &unstructured.Unstructured{Object: map[string]any{"apiVersion": "cr.bar.com/v1", "kind": "Foo", "metadata": map[string]any{"name": "test-5"}}}, metav1.CreateOptions{})
				if err != nil {
					t.Fatalf("unable to create cr: %v", err)
				}
		...
		},
		{
			...
			object: func(t *testing.T) (metav1.Object, string, string) {
				cr, err := crclient.Create(ctx, &unstructured.Unstructured{Object: map[string]any{"apiVersion": "cr.bar.com/v1", "kind": "Foo", "metadata": map[string]any{"name": "test-6"}}}, metav1.CreateOptions{})
				if err != nil {
					t.Fatalf("unable to create cr: %v", err)
				}
		...
		},
		{
			...
			object: func(t *testing.T) (metav1.Object, string, string) {
				cr, err := crclient.Create(ctx, &unstructured.Unstructured{Object: map[string]any{"apiVersion": "cr.bar.com/v1", "kind": "Foo", "metadata": map[string]any{"name": "test-7"}}}, metav1.CreateOptions{})
				if err != nil {
					t.Fatalf("unable to create cr: %v", err)
				}
		...
		},
		{
			...
			accept: "application/vnd.kubernetes.protobuf;as=PartialObjectMetadata;g=meta.k8s.io;v=v1",
			object: func(t *testing.T) (metav1.Object, string, string) {
				cr, err := crclient.Create(ctx, &unstructured.Unstructured{Object: map[string]any{"apiVersion": "cr.bar.com/v1", "kind": "Foo", "metadata": map[string]any{"name": "test-8", "annotations": map[string]string{"test": "0"}}}}, metav1.CreateOptions{})
				if err != nil {
					t.Fatalf("unable to create cr: %v", err)
				}
